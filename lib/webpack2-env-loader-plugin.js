...
class EnvLoaderWebpack2Plugin extends DefinePlugin {
  constructor(options) {
    ...
    const log = {
      info(text) {
        if (options.log) console.log(colors.yellow("EnvLoaderWebpack2Plugin: " + text));
      },
      error(text) {
        console.log(colors.red("EnvLoaderWebpack2Plugin: " + text));
      }
    };
...
module.exports = EnvLoaderWebpack2Plugin;
